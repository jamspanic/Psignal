...
%NotifyWhenDataAvailableExceeds parameter determines how fast the AI data index is updated. In other words,
%it determines the online AI sampling period = HW.AI.NotifyWhenDataAvailableExceeds/HW.params.fsAI.
%Here we use a 200 Hz online AI sampling rate vs. 1 khz aquisition rate
...
if ~isfield(globalparams,'speakercalibration') && ~isfield(HW.Calibration,'cdBSPL')
